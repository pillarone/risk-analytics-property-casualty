...
class ComplementarySurplusContractStrategyTests extends GroovyTestCase {
 ...
 private static List<UnderwritingInfo> getMockUnderwritingInfo1() {
    ...
    void testGetCededUnderwritingInfo2() {
        ...
        assertEquals "premium written 0", 1d * inUnderwritingInfos[0].premiumWritten, coverUnderwritingInfo[0].premiumWritten, EPSILON
        assertEquals "premium written 1", 0.5 * inUnderwritingInfos[1].premiumWritten, coverUnderwritingInfo[1].premiumWritten
        assertEquals "premium written 2", 0.2 * inUnderwritingInfos[2].premiumWritten, coverUnderwritingInfo[2].premiumWritten, EPSILON
    }
    ...
    void testGetCededUnderwritingInfo() {
        ...
        assertEquals "coverUnderwritingInfo.size", inUnderwritingInfos.size(), coverUnderwritingInfo.size()
        assertEquals "premium written 0", 1d * inUnderwritingInfos[0].premiumWritten, coverUnderwritingInfo[0].premiumWritten
        assertEquals "premium written 1", 0.5 * inUnderwritingInfos[1].premiumWritten, coverUnderwritingInfo[1].premiumWritten
        assertEquals "premium written 2", 0.2 * inUnderwritingInfos[2].premiumWritten, coverUnderwritingInfo[2].premiumWritten, EPSILON
