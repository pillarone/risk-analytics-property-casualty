...
class ReinsuranceContractTests extends GroovyTestCase {
    ...
    void testCalculateCededClaimsOnly() {
        ...
        ReinsuranceContract quotaShare1 = QuotaShareContractStrategyTests.getContract0()
    ...
    void testUsage() {
        ...
        quotaShare1 = QuotaShareContractStrategyTests.getContract0()
        quotaShare2 = QuotaShareAALContractStrategyTests.getContract0()
