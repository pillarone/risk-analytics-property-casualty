...
class SlidingCommissionStrategyTests extends GroovyTestCase {
    ...
    void testUsage() {
        ...
        assertEquals 'underwritingInfo200', -0d, underwritingInfos[0].fixedCommission, 1E-14
        ...
        assertEquals 'underwritingInfo200', -0d, underwritingInfos[1].fixedCommission, 1E-14
