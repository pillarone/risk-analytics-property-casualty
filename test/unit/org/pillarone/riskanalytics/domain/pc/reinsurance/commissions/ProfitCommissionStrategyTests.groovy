...
class ProfitCommissionStrategyTests extends GroovyTestCase {
    ...
    void testUsage() {
        ...
        assertEquals 'underwritingInfo100 fixed commission', -0d, underwritingInfo[0].fixedCommission, 1E-14
    ...
    void testAddition1() {
        ...
        assertEquals 'underwritingInfo100plus1 fixed commission', -0d, underwritingInfo[0].fixedCommission, 1E-14
    }
    ...
    void testUsageWithClaimDevelopmentLeanPacket() {
        ...
        assertEquals 'underwritingInfo100', -0d, underwritingInfo[0].fixedCommission, 1E-14
    }
}