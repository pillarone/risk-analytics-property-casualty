    ...
    mtpl {
        ...
        subRiProgram {
            subContract1 {
                ...
                parmContractStrategy[1] = ReinsuranceContractStrategyFactory.getContractStrategy(ReinsuranceContractType.QUOTASHARE, ["commission": 0.05, "quotaShare": 0.3, "coveredByReinsurer": 1d])
