...
components {
    ...
    fireClaims {
        parmDistribution[0] = RandomDistributionFactory.getDistribution(DistributionType.LOGNORMAL, ["mean": 100000, "stDev": 10000])
        parmDistribution[1] = RandomDistributionFactory.getDistribution(DistributionType.LOGNORMAL, ["mean": 100000, "stDev": 10000])
        parmDistribution[2] = RandomDistributionFactory.getDistribution(DistributionType.NORMAL, ["mean": 100000, "stDev": 11125])
    }
    hullClaims {
        parmDistribution[0] = RandomDistributionFactory.getDistribution(DistributionType.LOGNORMAL, ["mean": 100000, "stDev": 10000])
        parmDistribution[1] = RandomDistributionFactory.getDistribution(DistributionType.NORMAL, ["mean": 100000, "stDev": 11125])
        parmDistribution[2] = RandomDistributionFactory.getDistribution(DistributionType.NORMAL, ["mean": 100000, "stDev": 11125])
    }
}
