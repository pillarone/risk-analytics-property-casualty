...
components {
    ...
    reinsurance {
        subMotorHullWxl {
            ...
            parmCoveredLines[0] = new ComboBoxTableMultiDimensionalParameter([""], ["Covered Lines"], org.pillarone.modelling.domain.lob.LobMarker)
