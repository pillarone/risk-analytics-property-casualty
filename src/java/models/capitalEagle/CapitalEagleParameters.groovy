...
components {
    motorHull {
        ...
        subClaimsGenerator {
            subAttritionalClaimsGenerator {
                ...
                parmDistribution[0] = DistributionType.getStrategy(DistributionType.LOGNORMAL, [mean: 0.8, stDev: 0.054])
            ...
            subSingleClaimsGenerator {
                subClaimsGenerator {
                    ...
                    parmDistribution[0] = DistributionType.getStrategy(DistributionType.PARETO, [alpha: 0.523, beta: 500000.0])
                    parmModification[0] = DistributionModifier.getStrategy(DistributionModifier.TRUNCATED, [min: 500000.0, max: 2.0E7])
                }
        ...
        subRiProgram {
            ...
            subContract2 {
                parmContractStrategy[0] = ReinsuranceContractType.getStrategy(ReinsuranceContractType.STOPLOSS, ["premiumBase": PremiumBase.GNPI, "premium": 0.043, "attachmentPoint": 500000.0, "limit": 1.95E7, "coveredByReinsurer": 1.0,])
                parmInuringPriority[0] = 0
            }
            subContract3 {
    ...
    mtpl {
        ...
        subClaimsGenerator {
            subAttritionalClaimsGenerator {
                parmBase[0] = Exposure.PREMIUM_WRITTEN
                parmDistribution[0] = DistributionType.getStrategy(DistributionType.LOGNORMAL, [mean: 0.823, stDev: 0.07])
                parmModification[0] = DistributionModifier.getStrategy(DistributionModifier.NONE, [:])
            }
            subSingleClaimsGenerator {
                subClaimsGenerator {
                    ...
                    parmModification[0] = DistributionModifier.getStrategy(DistributionModifier.CENSORED, [min: 1000000.0, max: 1.0E8])
                }
                subFrequencyGenerator {
                    parmBase[0] = FrequencyBase.ABSOLUTE
    ...
    personalAccident {
        ...
        subClaimsGenerator {
            subAttritionalClaimsGenerator {
                parmBase[0] = Exposure.PREMIUM_WRITTEN
                parmDistribution[0] = DistributionType.getStrategy(DistributionType.LOGNORMAL, [stDev: 0.09, mean: 0.39])
                parmModification[0] = DistributionModifier.getStrategy(DistributionModifier.NONE, [:])
            }
            subSingleClaimsGenerator {
                subClaimsGenerator {
                    parmBase[0] = Exposure.ABSOLUTE
                    parmDistribution[0] = DistributionType.getStrategy(DistributionType.PARETO, [beta: 200000, alpha: 1.23])
                    parmModification[0] = DistributionModifier.getStrategy(DistributionModifier.TRUNCATED, [max: 3000000.0, min: 200000.0])
                }
                subFrequencyGenerator {
                    parmBase[0] = FrequencyBase.ABSOLUTE
    ...
    property {
        ...
        subClaimsGenerator {
            ...
            subAttritionalSeverityClaimsGenerator {
                parmBase[0] = Exposure.PREMIUM_WRITTEN
                parmDistribution[0] = DistributionType.getStrategy(DistributionType.LOGNORMAL, [mean: 0.563, stDev: 0.1137])
                parmModification[0] = DistributionModifier.getStrategy(DistributionModifier.NONE, [:])
            }
            subEQGenerator {
                subClaimsGenerator {
