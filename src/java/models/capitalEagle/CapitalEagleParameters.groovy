...
components {
    motorHull {
        ...
        subClaimsGenerator {
            subAttritionalClaimsGenerator {
                ...
                parmDistribution[0] = RandomDistributionFactory.getDistribution(DistributionType.LOGNORMAL, [mean: 0.8, stDev: 0.054])
            ...
            subSingleClaimsGenerator {
                subClaimsGenerator {
                    ...
                    parmDistribution[0] = RandomDistributionFactory.getDistribution(DistributionType.PARETO, [alpha: 0.523, beta: 500000.0])
                    parmModification[0] = DistributionModifierFactory.getModifier(DistributionModifier.TRUNCATED, [min: 500000.0, max: 2.0E7])
                }
        ...
        subRiProgram {
            ...
            subContract2 {
                parmContractStrategy[0] = ReinsuranceContractStrategyFactory.getContractStrategy(ReinsuranceContractType.STOPLOSS, ["premiumBase": PremiumBase.GNPI, "premium": 0.043, "attachmentPoint": 500000.0, "limit": 1.95E7, "coveredByReinsurer": 1.0,])
                parmInuringPriority[0] = 0
            }
            subContract3 {
    ...
    mtpl {
        ...
        subClaimsGenerator {
            subAttritionalClaimsGenerator {
                parmBase[0] = Exposure.PREMIUM_WRITTEN
                parmDistribution[0] = RandomDistributionFactory.getDistribution(DistributionType.LOGNORMAL, [mean: 0.823, stDev: 0.07])
                parmModification[0] = DistributionModifierFactory.getModifier(DistributionModifier.NONE, [:])
            }
            subSingleClaimsGenerator {
                subClaimsGenerator {
                    ...
                    parmModification[0] = DistributionModifierFactory.getModifier(DistributionModifier.CENSORED, [min: 1000000.0, max: 1.0E8])
                }
                subFrequencyGenerator {
                    parmBase[0] = FrequencyBase.ABSOLUTE
