        ...
        subClaimsGenerator {
            subSingleClaimsGenerator {
                subFrequencyGenerator {
                    ...
                    parmBase[allPeriods] = org.pillarone.modelling.domain.constants.FrequencyBase.ABSOLUTE
                }
                subClaimsGenerator {
                    ...
                    parmBase[allPeriods] = org.pillarone.modelling.domain.constants.Exposure.ABSOLUTE
                }
            }
            subAttritionalClaimsGenerator {
                ...
                parmBase[allPeriods] = org.pillarone.modelling.domain.constants.Exposure.PREMIUM_WRITTEN
