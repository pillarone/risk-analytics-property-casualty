 ...
 */
class ReinsuranceFACWithBouquetCommissionProgram extends ComposedComponent {
    ...
    DynamicMultiCoverAttributeFACReinsuranceProgram subContracts = new DynamicMultiCoverAttributeFACReinsuranceProgram()
