...
class CoverAttributeStrategyType extends AbstractParameterObjectClassifier {
    ...
    public String getConstructionString(Map parameters) {
        ...
        parameterString << ']'
        return "org.pillarone.riskanalytics.domain.pc.reinsurance.contracts.cover.CoverAttributeStrategyType.getStrategy(${this.class.name}.${typeName.toUpperCase()}, ${parameterString})"
    }
}
