    ...
    protected void filterInChannels() {
        if (parmCover instanceof NoneCoverAttributeStrategy) {
            ...
            List<LobMarker> coveredLines = parmCover instanceof ILinesOfBusinessCoverAttributeStrategy
                    ? (List<LobMarker>) (((ILinesOfBusinessCoverAttributeStrategy) parmCover).getLines().getValuesAsObjects(simulationScope.getModel())) : null;
            List<PerilMarker> coveredPerils = parmCover instanceof IPerilCoverAttributeStrategy
                    ? (List<PerilMarker>) ((IPerilCoverAttributeStrategy) parmCover).getPerils().getValuesAsObjects(simulationScope.getModel()) : null;
            List<IReserveMarker> coveredReserves = parmCover instanceof IReservesCoverAttributeStrategy
                    ? (List<IReserveMarker>) ((IReservesCoverAttributeStrategy) parmCover).getReserves().getValuesAsObjects(simulationScope.getModel()) : null;
