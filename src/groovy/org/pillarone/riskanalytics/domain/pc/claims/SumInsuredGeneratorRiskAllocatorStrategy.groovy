        ...
        claims.each {Claim claim ->
            ...
            switch (claim.claimType) {
                case ClaimType.SINGLE:     /*In this part only the single claims will be used*/
                    ...
                    expInfo.sumInsured = claimExp.getUltimate() + generator.nextValue() * (maxSumInsuredUWI - claimExp.getUltimate())   /*In this line, the MIL is generated, and written in the claimExp*/
